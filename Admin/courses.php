...
include('../dbConnection.php');
 ...
 ?>
  ...
  <div class="col-sm-9 mt-5">
    <!--Table-->
    <p class=" bg-dark text-white p-2" style=" border-radius: 20px;">&nbsp; List of Courses</p>
    <?php
      ...
      if($result->num_rows > 0){
       ...
       <tbody>';
        while($row = $result->fetch_assoc()){
          ...
          echo '<td>'.$row["course_lecturer"].'</td>';
          echo '<td><form action="editcourse.php" method="POST" class="d-inline"> <input type="hidden" name="id" value='. $row["course_id"] .'>
