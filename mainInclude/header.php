...
<head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      ...
      <img src="image/logo.jpeg" alt="logoimage" class="img-thumbnail " width="100" height="50">&nbsp;&nbsp; Samathvee</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          ?>
          <li class="nav-item custom-nav-item"><a href="About Us.php" class="nav-link">About Us</a></li> <br>
        </ul>
      </div>
    </nav> <!-- End Navigation -->
